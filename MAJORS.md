...
| W4   | `puppeteer-core`                                                   | 24.40.0 → 25.11.0 (PR #113)                | 25.11.0                                                   | 25.11.0 | current — clears the last high advisory (extract-zip chain) |
| W5   | `mermaid`                                                          | 11 → 12.0.0 (PR #114)                      | 12.0.0                                                    | 12.0.0  | current                                                     |
| W6   | `markdown-it`                                                      | 14 → 15.0.2 (PR #114)                      | 15.0.2                                                    | 15.0.2  | current                                                     |
| W7   | `katex`                                                            | 0.16.28 → 0.18.7 (PR #114)                 | 0.18.7                                                    | 0.18.7  | current — see nested-pin residual below                     |
